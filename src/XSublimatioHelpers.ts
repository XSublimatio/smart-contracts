...
export const MOLECULE_DESCRIPTIONS: string[] = [
    'Water is a very stable chemical substance, but also very reactive, is an excellent solvent in the liquid state. It is at the heart of the sulphurous theory of the "Memory of water", one according to which water which has been in contact with certain substances would keep an imprint of certain properties. According to this theory, water that has been in contact with certain substances retains an imprint of their properties even though they are no longer present.',
    ...
    'Lactupicrin is a lactone, component of lactucarium. It is a bitter substance which has a sedative and analgesic effect acting on the central nervous system.  ',
    ...
    'Baeocystin is an analog of psilocybin. This molecule presents psycoactive properties when combined with other metabolites of the mushroom',
    'Norbaeocystin is an analog of psilocybin. This molecule presents psycoactive properties when combined with other metabolites of the mushroom',
    'Psilocine is a hallucinogenic alkaloid isolated in trace amounts from Psilocybe mushrooms.',
    'Psilocybine is an alkaloid isolated from various genera of mushrooms. This molecule has hallucinogenic, anxiolytic and psychoactive activities.',
    ...
    'En référence à la "Salvia divinatorum", une plante puissante utilisée par les indiens mazatèques pour obtenir des visions religieuse, certain de ses constituants  ont été nommés divinatorin.',
    'En référence à la "Salvia divinatorum", une plante puissante utilisée par les indiens mazatèques pour obtenir des visions religieuse, certain de ses constituants  ont été nommés divinatorin.',
    ...
    'Salvinorin B is the major deacetylated metabolite of salvinorin A, a diterpene  with reported psychotropic activity, not observed in Salvinorin B.',
    'Salvinorin A is a substance with hallucinogenic properties. It is the main active psychotropic constituent of the entheogenic plant Salvia divinorum.',
...
export const DRUG_DESCRIPTIONS: string[] = [
    ...
    'The mandrake is a herbaceous plant of the Mediterranean countries, belonging to the family of the solanacées. This plant, rich in alkaloids with hallucinogenic properties, is surrounded by many legends, the ancients attributing extraordinary magical virtues to it.',
    'Maté is a traditional South American beverage originating from the culture of the Guaraní Indians. Mate is a stimulant, improving reactivity and concentration capacities.',
    'Derived from the latex of the poppy plant, opium, or "the poet\'s drug", is an opiate that produces feelings of orgasmic ecstasy and intense relaxation.',
    'Salvia Divinorumis a plant of the family of Lamiaceae native of Mexico. It is known for its psychotropic effects and is traditionally used in a mystical context by the Mazatec Indians during religious divination rites.',
];
